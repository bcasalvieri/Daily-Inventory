...
function Sidebar(props) {
  ...
  return (
    <div className="mb-5">
      ...
      <div className="sidebar-welcome mb-3">Welcome, {firstName}!</div>
      <Button block className="menu-button mb-3" onClick={props.saved}>
        <i class="fas fa-home mr-1" /> Home
      </Button>
      <NavLink to="/add" className="sidebar-link">
        <Button block className="menu-button mb-3">
          <i className="fas fa-plus mr-1" /> New Inventory
        </Button>
      </NavLink>
      <NavLink to="/summary" className="sidebar-link">
        <Button block className="menu-button mb-3">
          <i className="fas fa-glasses mr-1" /> Read All Inventories
        </Button>
      </NavLink>
      <Dropdown alignRight className="mb-3">
        <DropdownToggle block className="menu-button">
          <i className="fas fa-book-open mr-1" /> Resources
        </DropdownToggle>
      ...
      <Dropdown alignRight className="mb-3">
        <DropdownToggle block className="menu-button">
          <i className="fas fa-search-location mr-1" /> Find A Meeting
        </DropdownToggle>
